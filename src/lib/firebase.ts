...
import { getFirestore, serverTimestamp, addDoc, doc, deleteDoc, updateDoc, setDoc, deleteField } from "firebase/firestore";
...
export { app, auth, db, serverTimestamp, addDoc, doc, deleteDoc, updateDoc, setDoc, deleteField };
